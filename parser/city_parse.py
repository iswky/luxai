...
def city_parse():
    ...
    #     print("tender №", tender_info['Number'], ' in city: ', tender_info['City'])
    ...
    for tender in tenders_info:
        ...
        # print('Read city for tender №', number, ', with url: ', url)
